module.exports = new (function(params){
	...
	PMS_SHARD_TBLPMS_TABLENAMES_GET_BY_DATE_RANGE=PMS_SHARD_SCALAR_FUNCTIONS+'pms_shard_tblPms_tableNames_get_by_date_range',
	PMS_SHARD_TBLPMS_TABLENAME_LATEST_GET=PMS_SHARD_SCALAR_FUNCTIONS+'pms_shard_tblPms_tableName_latest_get',
	PMS_SHARD_PMS_TBLPMSX_SELECT_GET=PMS_SHARD_SCALAR_FUNCTIONS+'pms_shard_pms_tblPmsX_select_get';
